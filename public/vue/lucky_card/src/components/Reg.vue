...
export default {
    ...
    created() {
        ...
        if (window.localStorage.getItem("lucky_status_180908") == 2) {
            this.islucky = true;
        ...
        axios.get(this.myconf.api_host+"/luckycard/v1/getisstart").then(response => {
            if (response) {
    ...
    methods: {
        isLogin: function() {
            ...
            axios
                .post(this.myconf.api_host+"/luckycard/v1/signup", {
                    phone: this.phone
                })
                .then(response => {
